...
class Parser(report_base_vn.Parser):
    ...
    def __init__(self, cr, uid, name, context):
        ...
        self.report_name = 'htkk_sales_report'
        self.total = 0.0
        self.total2 = 0.0
        self.total_tax = 0.0
    ...
    def get_total2(self):
        return self.get_format_number(self.total2)
    ...
    def get_result_base_on_target(self):
        ...
        if data['from_period_id'] and data['from_period_id'][0] and \
            ...
            from_date = \
                period_obj.read(self.cr, self.uid, data['from_period_id'][0],
                                ['date_start'])['date_start']
            to_date = \
                period_obj.read(self.cr, self.uid, data['to_period_id'][0],
                                ['date_stop'])['date_stop']
        ...
        for invoice in invoice_obj.browse(self.cr, self.uid, invoice_ids):
            ...
            item = {
                ...
                'invoice_num': invoice.type == 'out_invoice' and
                invoice.customer_invoice_num or
        ...
        for voucher in voucher_obj.browse(self.cr, self.uid, voucher_ids):
            ...
            item = {
                ...
                'invoice_num': voucher.invoice_num,
        ...
        self.total2 = total_2 + total_3 + total_4 + total_5
    ...
    def get_wizard_data(self):
        ...
        date_start_str = self.pool.get('account.period').read(
            self.cr,
            self.uid, data[
                'from_period_id'][0], ['date_start'])
        date_start = datetime.strptime(date_start_str['date_start'],
